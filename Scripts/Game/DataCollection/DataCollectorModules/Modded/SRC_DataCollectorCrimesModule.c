...
modded class SCR_DataCollectorCrimesModule
{
	override protected float EvaluateHarmingFriendlies(notnull SCR_PlayerData playerData)
	{
		...
		float harmingUnarmedPoints = accumulatedActions[SCR_EDataStats.FRIENDLY_KILLS] * MODIFIER_PROPORTIONALITY_FRIENDLY_KILLS + accumulatedActions[SCR_EDataStats.FRIENDLY_AI_KILLS] * MODIFIER_PROPORTIONALITY_FRIENDLY_AI_KILLS;
